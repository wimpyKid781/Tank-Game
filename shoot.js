AFRAME.registerComponent("bullets", {
 ...
 removeBullet: function (e) {
    ...
    if (elementHit.id.includes("enemy")) {
      //Add code here
      var countTankElements = document.querySelector("#countTank")
      var tanksFired = parseInt(countTankElements.getAttribute("text").value)
      tanksFired -= 1;
      countTankElements.setAttribute("text",{
        value: tanksFired,
      })
        if(tanksFired === 0){
